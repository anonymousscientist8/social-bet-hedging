  ...
  [
    ...
    [
      ...
      [
        ...
        [ ifelse who < round(Bats * 2 / 3)
          [
            set color orange
            set decision 3
          ]
          [
            ifelse who < round(Bats * 5 / 6)
            [
              set color yellow
              set decision 5
            ]
...
"pen-5" 1.0 0 -13345367 true "" "plot count turtles with [decision = 5]"
"pen-6" 1.0 0 -8630108 true "" "plot count turtles with [decision = 6]"
